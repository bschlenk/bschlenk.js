 ...
 */
export function fromClientXY(e: HasClientXY): Vector {
 ...
 */
export function fromDeltaXY(e: HasDeltaXY): Vector {
 ...
 */
export function fromMovementXY(e: HasMovementXY): Vector {
  return vec(e.movementX, e.movementY)
}

/**
 * Get a vector representing the top left point of the given `el`. Uses
 * `getBoundingClientRect`, so this is the point after transforms are applied.
 */
export function fromElementTopLeft(el: HTMLElement): Vector {
  const box = el.getBoundingClientRect()
  return vec(box.x, box.y)
}

/**
 * Get a vector representing the size of the window.
 */
export function fromWindow(): Vector {
